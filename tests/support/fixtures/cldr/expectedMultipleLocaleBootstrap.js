...
i18n.setCldrLoaders({ 'en': function() {
	...
	if (has('__i18n_date__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/fr/date-time" */ 'cldr-data/main/fr/ca-gregorian.json')
		);
		promises.push(
			import(/* webpackChunkName: "i18n/fr/date-time" */ 'cldr-data/main/fr/dateFields.json')
		);
		promises.push(
			import(/* webpackChunkName: "i18n/fr/date-time" */ 'cldr-data/main/fr/timeZoneNames.json')
		);
	}
	if (has('__i18n_number__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/fr/currency" */ 'cldr-data/main/fr/currencies.json')
		);
	}
	if (has('__i18n_date__') || has('__i18n_number__') || has('__i18n_unit__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/fr/common" */ 'cldr-data/main/fr/numbers.json')
		);
	}
	if (has('__i18n_unit__')) {
		promises.push(import(/* webpackChunkName: "i18n/fr/unit" */ 'cldr-data/main/fr/units.json'));
	}
	...
	if (has('__i18n_date__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/ja/date-time" */ 'cldr-data/main/ja/ca-gregorian.json')
		);
		promises.push(
			import(/* webpackChunkName: "i18n/ja/date-time" */ 'cldr-data/main/ja/dateFields.json')
		);
		promises.push(
			import(/* webpackChunkName: "i18n/ja/date-time" */ 'cldr-data/main/ja/timeZoneNames.json')
		);
	}
	if (has('__i18n_number__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/ja/currency" */ 'cldr-data/main/ja/currencies.json')
		);
	}
	if (has('__i18n_date__') || has('__i18n_number__') || has('__i18n_unit__')) {
		promises.push(
			import(/* webpackChunkName: "i18n/ja/common" */ 'cldr-data/main/ja/numbers.json')
		);
	}
	if (has('__i18n_unit__')) {
		promises.push(import(/* webpackChunkName: "i18n/ja/unit" */ 'cldr-data/main/ja/units.json'));
	}
	...
	var promises = [
		...
		Promise.resolve({ default: {"supplemental":{"version":{"_unicodeVersion":"12.1.0","_cldrVersion":"36"},"plurals-type-cardinal":{"en":{"pluralRule-count-one":"i = 1 and v = 0 @integer 1","pluralRule-count-other":" @integer 0, 2~16, 100, 1000, 10000, 100000, 1000000, … @decimal 0.0~1.5, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, …"},"fr":{"pluralRule-count-one":"i = 0,1 @integer 0, 1 @decimal 0.0~1.5","pluralRule-count-other":" @integer 2~17, 100, 1000, 10000, 100000, 1000000, … @decimal 2.0~3.5, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, …"},"ja":{"pluralRule-count-other":" @integer 0~15, 100, 1000, 10000, 100000, 1000000, … @decimal 0.0~1.5, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, …"}}}} })
	];
